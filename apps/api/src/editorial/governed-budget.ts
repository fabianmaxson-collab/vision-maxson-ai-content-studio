  ...
  if (chainedSchema) {
    ...
    if (
      ...
      classifyChainedRemediationDiagnostic(
        chainedEnvelope.runSafeMetadataJson,
        chainedEnvelope.attemptSafeMetadataJson,
      ) === 'duplicate_continuity_key'
    )
      envelope = chainedEnvelope;
  }
  if (!envelope)
